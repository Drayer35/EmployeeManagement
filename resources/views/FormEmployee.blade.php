...
@section('content-section')
    <div class="content-form-user">
        ...
        <form class="form-employee" method="POST" id="form-employee">
            ...
            <div class="inputs"><input type="text" id="dateAdmision" name='dateAdmission' placeholder={{__('Date Admission')}} autofocus required  autocomplete="off"></div>
            <div class="inputs"><input type="text" id="nombre" name='nombre' placeholder={{__('Name')}} required  autocomplete="off"></div>
            <div class="inputs"><input type="text" id="lastName" name='lastName' placeholder={{__('Last Name')}} required autocomplete="off"></div>
            <div class="inputs"><input type="text" id="birthdate" name='birthdate' placeholder={{__('Birthdate')}} required autocomplete="off" ></div>
