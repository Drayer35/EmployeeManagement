    ...
    <div class="max-w-screen-lg mx-auto">
        <div class="w-full flex h-auto bg-white">
            <form class="w-full flex" id="form-employee" name="form-employee"
                wire:submit="save" method="POST" action="{{ route('save')}}" 
                ...
                <div class="column2 mx-7  ">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6  md:mb-6">
                            ...
                            <input wire:model='name' class="rounded appearance-none block w-full bg-transparent text-gray-700 border border-gray-200  py-3 px-4 leading-tight" 
